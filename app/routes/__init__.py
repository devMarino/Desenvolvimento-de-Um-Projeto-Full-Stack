# Importa o blueprint das páginas (loja, login, etc.)
from app.routes.frontend_routes import frontend_bp

# Importa os blueprints da API
...
def register_blueprints(app):
    # Registra o blueprint das páginas (sem prefixo)
    # (Ele agora se chama 'main' internamente, como definido no outro arquivo)
    app.register_blueprint(frontend_bp)

    # Registra os blueprints da API (com prefixos)
